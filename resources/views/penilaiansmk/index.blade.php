        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <strong class="card-title">Setting Nilai<a href="{{ route('penilaiansmk.create') }}" role="button" style="float: right;" class="btn btn-info btn-sm my-2 my-sm-0"><i class="fa fa-plus"></i>&nbsp;Tambah Data</a></strong>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" width="13,5%">
                                        <form action="{{ route('penilaiansmk.destroy',$penilaian->id) }}" method="POST">
                                            <a class="btn btn-info btn-circle" role="button" href="{{ url('raport-smk',$penilaian->siswa_id)}}" ><i class= "fa fa-print"></i>&nbsp;Cetak Raport</a>
                                            @csrf
                                            @method('DELETE')
