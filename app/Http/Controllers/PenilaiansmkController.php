...
class PenilaiansmkController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        ->where('kategori.id','=','2')
        ->get();
        return view('penilaiansmk.index', compact('ar_penilaian'));
    }
    ...
    public function store(Request $request)
    {
        ...
        ->insert(
            [
                ...
                'sekolah_id'=>$request->walas,
                'rangking'=>$request->rangking
            ]
        );
        //landing page
        return redirect()->route('penilaiansmk.index')
    ...
    public function destroy($id)
    {
        ...
        return redirect('/penilaiansmk');
    }
    public function pdfsmk(Request $request, $id)
    {           
     $ar_smk = DB::table('penilaian')
     ->join('siswa', 'siswa.id', '=', 'penilaian.siswa_id')
     ...
     ->get();
     $pdf = PDF::loadView('penilaiansmk.raport',['ar_smk' =>$ar_smk ] )
