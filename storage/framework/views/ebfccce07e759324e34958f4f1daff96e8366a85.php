        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <strong class="card-title">Setting Nilai<a href="<?php echo e(route('penilaian.create')); ?>" role="button" style="float: right;" class="btn btn-info btn-sm my-2 my-sm-0"><i class="fa fa-plus"></i>&nbsp;Tambah Data</a></strong>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" width="13,5%">
                                        <a class="btn btn-info btn-circle" role="button" href="<?php echo e(url('raport-smp')); ?>" ><i class= "fa fa-print"></i>&nbsp;Cetak Raport</a>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-rapor\resources\views/penilaian/index.blade.php ENDPATH**/ ?>