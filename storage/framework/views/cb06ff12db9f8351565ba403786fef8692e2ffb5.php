        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <strong class="card-title">Setting Nilai<a href="<?php echo e(route('penilaiansmp.create')); ?>" role="button" style="float: right;" class="btn btn-info btn-sm my-2 my-sm-0"><i class="fa fa-plus"></i>&nbsp;Tambah Data</a></strong>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" width="13,5%">
                                            <form action="<?php echo e(route('penilaiansmp.destroy',$penilaian->id)); ?>" method="POST">
                                            <a class="btn btn-info btn-circle" role="button" href="<?php echo e(url('raport-smp',$penilaian->siswa_id)); ?>" ><i class= "fa fa-print"></i>&nbsp;Cetak Raport</a>
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-rapor\resources\views/penilaiansmp/index.blade.php ENDPATH**/ ?>