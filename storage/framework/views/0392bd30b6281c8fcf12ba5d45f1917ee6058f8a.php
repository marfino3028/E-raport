       ...
       <div class="card" style="">
        ...
        <div class="card-body">
          <div class=" card card-body  mb-2">
            <form method="POST" action="<?php echo e(route('walas.update',$edit->id)); ?>"
              ...
              <div class="form-group row">
                ...
                <div class="col-8">
                <input id="nip" name="nip" type="text" class="form-control" required="required" value="<?php echo e($edit->nip); ?>" />
                </div>
            </div>
            <div class="form-group row">
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-rapor\resources\views/walas/form_edit.blade.php ENDPATH**/ ?>