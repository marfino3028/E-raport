                ...
                <table border="1" cellspacing="0" width="100%" cellspacing="0">
                  ...
                  <?php $__currentLoopData = $ar_smk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $smk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                    <tr>
                        ...
                        <td class="text-center"><?php echo e($smk->nis); ?></td>
                        <td class="text-center"><?php echo e($smk->nama); ?></td>
                        <td class="text-center"><?php echo e($smk->kelas); ?></td>
                        <td class="text-center"><?php echo e($smk->jenis); ?></td>
                        <td class="text-center"><?php echo e($smk->tempat_lahir); ?></td>
                        <td class="text-center"><?php echo e($smk->tanggal_lahir); ?></td>
                        <td class="text-center"><?php echo e($smk->alamat); ?></td>
                    </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
                </tbody>

                </table>
</html><?php /**PATH C:\xampp\htdocs\E-rapor\resources\views/smk/DataSMK.blade.php ENDPATH**/ ?>