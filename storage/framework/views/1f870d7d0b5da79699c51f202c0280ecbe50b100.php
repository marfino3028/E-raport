...
<?php
$ar_judul = ['No','Semester','Tahun Ajaran','Action'];
$no = 1;
?>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Tahun Akademik<a href="<?php echo e(route('tahun_akademik.create')); ?>" role="button" style="float: right;" class="btn btn-info btn-sm my-2 my-sm-0"><i class="fa fa-plus"></i>&nbsp;Tambah Data</a></strong>
                    </div>
                    <div class="card-body">
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" width="35%"><?php echo e($thn->semester); ?></td>
                                    <td class="text-center" width="35%"><?php echo e($thn->tahun); ?></td>
                                    <td class="text-center" width="20%">
                                        <form action="<?php echo e(route('tahun_akademik.destroy',$thn->id)); ?>" method="POST">
                                        <a class="btn btn-info btn-circle" role="button" href="<?php echo e(route('tahun_akademik.show',$thn->id)); ?>" ><i class= "fa fa-list-alt"></i>&nbsp;Lihat</a>
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-rapor\resources\views/tahun/index.blade.php ENDPATH**/ ?>