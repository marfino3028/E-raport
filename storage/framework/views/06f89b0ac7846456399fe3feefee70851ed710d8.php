...
<form method="POST" action="<?php echo e(route('penilaiansmp.store')); ?>"  enctype="multipart/form-data">
	<?php echo csrf_field(); ?>
	...
	<div class="form-group row">
		...
		<div class="col-8">
			<select name="kepsek" class="custom-select">
				...
				<option value="<?php echo e($kepsek['id']); ?>"> <?php echo e($kepsek['nip']); ?> - <?php echo e($kepsek['nama_kepsek']); ?> </option>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			</select>
		</div>
	</div>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-rapor\resources\views/penilaiansmp/form.blade.php ENDPATH**/ ?>